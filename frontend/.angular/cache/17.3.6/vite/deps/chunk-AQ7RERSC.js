...
function shouldInclude(_a2, variables) {
  ...
  return getInclusionDirectives(directives).every(function(_a3) {
    ...
    if (ifArgument.value.kind === "Variable") {
      ...
      invariant2(evaledValue !== void 0, 67, directive.name.value);
    } else {
...
function getInclusionDirectives(directives) {
  ...
  if (directives && directives.length) {
    directives.forEach(function(directive) {
      ...
      invariant2(directiveArguments && directiveArguments.length === 1, 68, directiveName);
      var ifArgument = directiveArguments[0];
      invariant2(ifArgument.name && ifArgument.name.value === "if", 69, directiveName);
      var ifValue = ifArgument.value;
      invariant2(ifValue && (ifValue.kind === "Variable" || ifValue.kind === "BooleanValue"), 70, directiveName);
...
function getFragmentQueryDocument(document, fragmentName) {
  ...
  if (typeof actualFragmentName === "undefined") {
    invariant2(fragments.length === 1, 72, fragments.length);
...
function getFragmentFromSelection(selection, fragmentMap) {
  switch (selection.kind) {
    ...
    case "FragmentSpread": {
      ...
      invariant2(fragment, 73, fragmentName);
...
function checkDocument(doc) {
  invariant2(doc && doc.kind === "Document", 74);
  ...
  invariant2(operations.length <= 1, 76, operations.length);
  return doc;
}
...
function getQueryDefinition(doc) {
  ...
  invariant2(queryDef && queryDef.operation === "query", 77);
  return queryDef;
}
function getFragmentDefinition(doc) {
  invariant2(doc.kind === "Document", 78);
  invariant2(doc.definitions.length <= 1, 79);
  var fragmentDef = doc.definitions[0];
  invariant2(fragmentDef.kind === "FragmentDefinition", 80);
  return fragmentDef;
}
      ...
      if (this.cached) {
        ...
        this.performWork = wrap3(DocumentTransform2.prototype.performWork.bind(this), {
          makeCacheKey: function(document) {
            ...
            if (cacheKeys) {
              invariant2(Array.isArray(cacheKeys), 66);
...
function removeDirectivesFromDocument(directives, doc) {
  ...
  var getInUse = function(ancestors) {
    ...
    globalThis.__DEV__ !== false && invariant2.error(83);
    return null;
  };
...
var { toString: toString2, hasOwnProperty: hasOwnProperty7 } = Object.prototype;
  ...
  switch (aTag) {
    ...
    case "[object Object]": {
      ...
      for (let k = 0; k < keyCount; ++k) {
        if (!hasOwnProperty7.call(b, aKeys[k])) {
          return false;
        }
      }
      for (let k = 0; k < keyCount; ++k) {
...
var ApolloCache = (
  ...
  function() {
    ...
    ApolloCache2.prototype.watchFragment = function(options) {
      var _this = this;
      var fragment = options.fragment, fragmentName = options.fragmentName, from2 = options.from, _a2 = options.optimistic, optimistic = _a2 === void 0 ? true : _a2;
      var diffOptions = {
...
//# sourceMappingURL=chunk-AQ7RERSC.js.map
